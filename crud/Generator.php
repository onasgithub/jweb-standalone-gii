...
namespace jweb\gii\crud;

use jweb\gii\crud\providers\CallbackProvider;
use jweb\gii\crud\providers\DateTimeProvider;
use jweb\gii\crud\providers\EditorProvider;
use jweb\gii\crud\providers\OptsProvider;
use jweb\gii\crud\providers\RelationProvider;
use jweb\gii\crud\providers\PhotoProvider;
use Yii;
...
class Generator extends \yii\gii\generators\crud\Generator {
    ...
    public function activeField(ColumnSchema $column, $model = null) {
        ...
        if ($code !== null) {
            ...
            return self::generateActiveField($column->name);
        };
    }
    ...
    public function generateActiveField($attribute) {
        ...
        if ($column->phpType === 'boolean' || ($column->type = 'integer' && $column->size === 1)) {
            //       print_r($column);die();
    ...
    private function shorthandAttributeFormat($attribute) {
        ...
        if ($attribute->phpType === 'boolean' || ($attribute->size == 1) && $attribute->phpType === 'integer') {
            $format = 'boolean';
